...
# Astronomy]-]-]
It is important to first settle the physical dimension of this universe. Because all of the story doesn't revolve around a puny region. As every stellar object can impact culture, events and gravity, we have to detail them. Below a sketch of the different objects of the system. We ignore for now their signification, as we call a spade a spade.

*N.B. All astronomical values are put as aproximatives.*

## Solar system]-]
![Astronomy of DRC](https://cdn.discordapp.com/attachments/884688687126937600/971005038724001852/Drc_system.png)
...
### Wanderer]-
until one last purple gas planet with a bent orbit takes centuries to alternate between upper and lower angle in one revolution.

Every culture on earth has different names and interpretations for these objects. This is why in the document the names will refer to these codes.
